The project is a web application that allows users to buy and sell stocks. The application uses Flask as the back-end framework, SQLite3 as the database, and Bootstrap for the front-end.
